...
import { itemStep8 } from "../../../utils/listLocalStorage";
...
const Step08 = () => {
  ...
  const nextStep = (option) => {
    ...
    if (localStorage.getItem("kidsOrDependant") !== option) {
      currentStep(8, itemStep8);
    }
  ...
  return (
    <LifeInsurance isShowHeader activeStep={8} numberScroll={500}>
