...
const Form = () => {
  ...
  useEffect(() => {
    beginPage(history, "/refinance-fact-find-3");
  }, [history]);
  ...
  useEffect(() => {
    if (history.action === "POP") {
      setTimeout(() => {
        ...
        history.replace({
          pathname: "/refinance-fact-find-3",
  ...
  return (
    <section className="form">
      <Switch>
        <Route
          path="/refinance-fact-find-3/user-details"
          component={UserDetails}
        />
        <Route
          path="/refinance-fact-find-3/loanInformation"
          component={LoanInformation}
        />
        <Route
          path="/refinance-fact-find-3/ApplicantDetails"
          component={ApplicantDetails}
        />
        <Route
          path="/refinance-fact-find-3/KidsOrDependants"
          component={KidsOrDependants}
        />
        <Route
          path="/refinance-fact-find-3/EmploymentStatus"
          component={EmploymentStatus}
        />
        <Route
          path="/refinance-fact-find-3/Liabilities"
          component={Liabilities}
        />
        <Route
          path="/refinance-fact-find-3/CreditCards"
          component={CreditCards}
        />
        <Route
          path="/refinance-fact-find-3/ResidentialInformation"
          component={ResidentialInformation}
        />
        <Route path="/refinance-fact-find-3/step-success" component={Success} />
        <Route path="/refinance-fact-find-3/step-reset" component={StepReset} />
        <Route path="/refinance-fact-find-3/" component={UserDetails} />
      </Switch>
    </section>
  );
};
