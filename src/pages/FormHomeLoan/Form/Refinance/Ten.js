          ...
          >
            <Row>
              <Col xs={12} className="text-center">
                <h2>
                  Alright, your results are ready. <br className="d-block" />
                ...
                <Row className="info-customer">
                  ...
                  <Col xs={12} className="wForm-input mt-3 p-0">
                    <InputNumber
                      ...
                      onKeyPress={onKeyDown}
                      onChange={(e) => onKeyUpHandle("phone", e.target.value)}
                ...
                {phoneValid === valid.INVALID && (
                  <div className="text-error">
                    ...
                    (phone.length >= 2 && phone?.slice(0, 2) === "04") ? (
                      ...
                      <p>
                        Please enter in a valid mobile number starting with 04
                      </p>
                    )}
                  </div>
                )}
              </Col>
              <Col xs={12} className="col d-flex justify-content-center mt-4 ">
                <Button
