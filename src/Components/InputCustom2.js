...
import imgIconSearch from "../images/search.svg";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {iconSearch && (
          <div className="icon check-phone search" onClick={handleSearch} title="Search">
            <img src={imgIconSearch} alt="Search" className="iconEmail " />
          </div>
        )}
      </div>
    </div>
